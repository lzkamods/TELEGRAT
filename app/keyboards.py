...
os_control = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text='Девайсы⌨️', callback_data='devices')],
    [InlineKeyboardButton(text='Назад⬅️', callback_data='back')]
])

dvcs = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Нажать клавишу⌨️', callback_data='keyb')],
    [InlineKeyboardButton(text='Мышь🖱️', callback_data='mse')],
    [InlineKeyboardButton(text='Назад⬅️', callback_data='back_os')]
])

mose = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Клик ЛКМ', callback_data='lkm')],
    [InlineKeyboardButton(text='Клик ПКМ', callback_data='pkm')],
])
